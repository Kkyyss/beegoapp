...
func init() {
	...
	beego.Router("/user/notification-console", &controllers.AdminNotificationController{})
	...
	beego.Router("/api/view-notification-list", &controllers.NotificationListController{})
